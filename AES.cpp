...
uint8_t gadd(uint8_t a, uint8_t b){return a^b;}    //GF(2^8) 加法
uint8_t gsub(uint8_t a, uint8_t b){return a^b;}    //GF(2^8) 减法
uint8_t gmult(uint8_t a, uint8_t b){               //GF(2^8) 乘法
...
int K;      // 密钥
int Nb=4;   // 列数4 (在此标准下32位字) Nb=4
int Nk;     // 密钥列数 Nk=4,6,8
int Nr;     // 轮的数量 和nk和nb有关 10,12,14
